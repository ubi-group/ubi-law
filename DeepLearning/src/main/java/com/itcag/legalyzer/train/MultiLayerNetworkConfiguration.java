...
public class MultiLayerNetworkConfiguration {
     ...
     * The available options are provided by the {@link com.itcag.legalyzer.train.Updaters Updaters} enum.
     * @param config Instance of the Java Property class.
     */
...
//        config.setProperty("l1", "1e-5");
     ...
     * The available options are provided by the {@link com.itcag.legalyzer.train.InitialWeightStrategies InitialWeightStrategies} enum.
     * @param config Instance of the Java Property class.
     */
