...
//            uiServer.attach(statsStorage);
            ...
            model.setListeners(new ScoreIterationListener(20), new EvaluativeListener(testIter, 1, InvocationType.EPOCH_END));   //Print the score (loss function value) every 20 iterations
