...
/*
 * This is not our class. It is pretty messy, but it works well.
 * Do not modify it. If required, rewrite it our way.
 * 
 * It receives two strings and compares them.
 * It returns a list of elements that are either identical,
 * or missing in the second string, or occurring in the second
 * but missing in the first string.
 * 
 * There is an option for "semantic" cleanup, which takes very
 * granulated list of differences (for example, containing single
 * characters when two strings differ in every second character),
